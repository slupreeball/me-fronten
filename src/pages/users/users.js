 ...
 useEffect(() => {
  ...
  const DataDelete = id => {
    ...
    var requestOptions = {
      ...
      fetch(apiUrl+"/deleteuser/" + id, requestOptions)
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table" size="small" >
                <TableHead >
                  <TableRow >
                      ...
                      <TableCell align="left" style={headStyle}>อีเมล</TableCell>
                ...
                {items.map((row) => (
                    ...
                    <TableCell align="left" style={bodyStyle}>{row.email}</TableCell>
                    <TableCell align="right" style={bodyStyle}>
                    <ButtonGroup variant="outlined" aria-label="outlined button group" size="small">
                        <Button onClick={()=>DataUpdate(row.user_id)}>Edit</Button>
                        <Button onClick={()=>handleClickOpen(row.user_id)}>Delete</Button>
                    </ButtonGroup>
                    </TableCell>
                    </TableRow>
                ))}
